...
function toggleCategory(path, isChecked) {
    ...
    // If a parent is clicked, update all children to match its state
    if (isChecked) {
        // Ensure parents are selected when a child is checked
    ...
    // Update children when a parent is toggled
