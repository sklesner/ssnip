...
import * as PROMPT from './prompt0011.mjs'
...
import * as TEMPLATE from './template0014.mjs'
...
export async function onRequest(context) {  
  ...
  const backgroundWork = async () => {
    ...
    const storySpec = await ctx.generator.makeStorySpec(ctx, lesson,storyName,emojiArray);
